...
from uwb_position.trilateration import solve_position_3d

DEFAULT_ANCHOR_CONFIG = Path(__file__).resolve().parents[1] / "config" / "anchors.example.json"


def load_anchors(config_path=DEFAULT_ANCHOR_CONFIG):#读取基站配置文件，返回 numpy 数组 (N,3) 方便后面快速运算
